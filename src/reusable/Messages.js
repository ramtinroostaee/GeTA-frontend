...
export const FIELD_NUMBER = "این فیلد باید عدد باشد";

export const USERNAME_REQUIRED = "کد ملی الزامی است";
...
export const SUCCESS_SUBMIT = "درخواست شما ثبت شد";
export const SURE_TO_DELETE = "آیا مطمئنید که میخواهید حذف کنید؟";
export const SUCCESSFULY_DELETED = "با موفقیت حذف شد";
...
export const Success_Add_Role = "نقش با موفقیت ثبت شد";
...
export const Success_Update_Driver = "راننده موردنظر ویرایش شد";
export const Success_Update_Role = "نقش موردنظر ویرایش شد";
...
export const Success_Add_Route = "مسیر با موفقیت ایجاد شد";
export const Success_Update_Route = "مسیر با موفقیت ویرایش شد";
